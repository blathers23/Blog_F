...
至此，我们找到了一种上下对应的关系。换句话说：**如果我们已知** $n=8,k=3$ **时何数的去留，我们便能通过数学关系** {{<raw>}}$(x+k) \% n${{</raw>}} **得知** $n=9,k=3$ **时何数的去留**。这是因为由上图可知，**去留关系应该是一一对应的**。
...
Update：Hugo在渲染文档时会将一些转义字符自动进行转义处理，因此需要额外增加一个转义字符。FixIt主题支持[raw shortcode](https://fixit.lruihao.cn/zh-cn/theme-documentation-content/#%E6%95%B0%E5%AD%A6%E5%85%AC%E5%BC%8F)以避免这些转义字符。(Jan/2/2023)
